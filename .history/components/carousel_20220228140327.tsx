        ...
        <Row className="mt-3">
            <Col md="5">
                <div className={`${styles.baseShadow} ${styles.projCarousel}`} >
                    ...
                    <a href="https://bassi-and-associates.vercel.app/" target="_blank" rel="noopener noreferrer" title="Law firm website">Bassi &amp; Associates</a>
            ...
            <Col md={{offset:2, span:5}}>
                <div className={`${styles.baseShadow} ${styles.projCarousel}`}>
                    ...
                    <div className='pt-3 pb-1'>
                    <a href="https://ishan-bna.vercel.app/" target="_blank" rel='noopener noreferrer' title="A simple blog">Blog website</a>
