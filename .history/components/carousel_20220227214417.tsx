...
export default function ProjectCarousel() {
    return(
        ...
        <Row className="mt-3">
            <Col md="5" className={`${styles.baseShadow} ${styles.skillsImg}`}>
                <Carousel variant="dark" >
                    ...
                    <CarouselItem interval={3000}>
                        <Image src={bassiPart2} sizes="50vw" layout='fill'  />
            ...
            <Col md={{offset:2, span:5}} className={`${styles.baseShadow} ${styles.skillsImg}`}>
                <Carousel variant="dark">
                    <CarouselItem >
