...
const imgPath = path.join(process.cwd() , ' public/fullStack.jpg')
    ...
    <div className='text-center mt-5'>
      ...
      <Container className={styles.container}>
        ...
        <div className={styles.profileImgCover}> 
          <Image src="/../public/fullStack.jpg" priority className={styles.profileImg} height="180" width="180"></Image>
        </div>
      </Container>    
      <Container>
        <h1>Hi</h1>
      ...
      <Container>
        <Row>
          <Col>
            ...
            <img src={imgPath} alt="full stack"  width="1000" height="1000" />
          </Col>
        </Row>
      </Container>
    </div>
