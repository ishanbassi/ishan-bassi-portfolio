  ...
  return (
    ...
    <div className='text-center mt-5'>
      ...
      <Container>
        <Row >
          <Col md="6">
            <Image  src={fullStack} alt="full stack" layout='responsive'   placeholder="blur" sizes="50vw" width={3000} height={2000} />
          </Col>
          <Col md="6">
            <Image  src={seo} alt="seo-support" layout='responsive'   placeholder="blur" sizes="50vw" width={2000} height={2000} />
          </Col>
          <Col md="6">
            <Image  src={spa} alt="single-page-apps" layout='responsive'   placeholder="blur" sizes="50vw" width={7730} height={7730}/>
          </Col>
        </Row>
      </Container>
    </div>
