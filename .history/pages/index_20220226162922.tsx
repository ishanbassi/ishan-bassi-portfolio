...
const Home: NextPage<{markdown:string}> = ({markdown}) => {
  ...
  return (
    ...
    <div className='text-center mt-5'>
      ...
      <Container fluid="md" className="mt-5" ref={bioRef}>
        <h1>About Me</h1>
        ...
        <Row className='mt-2'>
          <Col md="5">
            <div className={styles.skillsImg}>
              <Image  src={fullStack} alt="full stack" layout='fill'   placeholder="blur" sizes="50vw" objectFit="cover"/> 
          ...
          <Col md={{offset:2 , span:5}}>
            <div className={styles.skillsImg}>
              <Image  src={seo} alt="seo support" layout='fill'   placeholder="blur" sizes="50vw"  objectFit="cover"/>
          ...
          <Col className="mt-2" md={5}>
            <div className={styles.skillsImg}>
              <Image  src={ui} alt=" UI development" layout='fill'   placeholder="blur" sizes="50vw"  objectFit="cover" />
              
            </div>
            <h4>UI Development</h4>
          </Col>
          <Col className="mt-2" md={{offset:2 , span:5}}>
            <div className={styles.skillsImg}>
              <Image  src={spa} alt="single page applications" layout='fill'   placeholder="blur"   objectFit="cover" sizes='50vw'/>
