      ...
      <Container className="mt-5">
        ...
        <div className={styles.bio}>
          <ul>
            ...
            <li><b className={styles.bioHeads}>Age :</b> <span className={styles.bioAns}>21</span> </li>
            <li><b className={styles.bioHeads}>Qualification :</b><span className={styles.bioAns}>B.A. LL.B , Panjab Univserity, Chandigarh (current)</span> </li>
