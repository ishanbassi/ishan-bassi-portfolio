  ...
  return (
    ...
    <div className='text-center mt-5'>
      ...
      <Container>
        ...
        <Row>
          <Col className={styles.socialLinks} ><i className={`fa-brands fa-facebook-f `}></i></Col>
          <Col className={styles.socialLinks}><i className={`fa-brands fa-instagram-square `}></i></Col>
          <Col className={styles.socialLinks}><i className={`fa-brands fa-linkedin `}></i></Col>
          <Col className={styles.socialLinks}><i className={`fa-brands fa-stack-overflow `}></i></Col>
        </Row>
