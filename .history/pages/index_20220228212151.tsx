    ...
    <div className='text-center mt-5'>
      ...
      <Container>
        ...
        <Row>
          ...
          <Col id={styles.instaLink}className={styles.socialLinks}><a href="https://www.instagram.com/ishan__bassi/"target="_blank" rel="noopener noreferrer "  title="Instagram Profile"><i className={`fa-brands fa-instagram-square `}></i></a></Col>
