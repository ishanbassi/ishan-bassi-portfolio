...
const Home: NextPage<{markdown:string}> = ({markdown}) => {
  ...
  return (
    ...
    <div className='text-center mt-5'>
      ...
      <Container>
        <Row>
          <Col md={{span:8, offset:2}}  className={styles.aboutMe}>
          <h2>About Me</h2>
          <p>
          I have been doing full stack web development for the last one year. Started learning in
          2019, my first encounter with programming was through <b>Python <i className="fa-solid fa-face-laugh-beam"></i></b> , but now most of 
