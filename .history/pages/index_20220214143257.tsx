      ...
      <Container className="mt-5">
        ...
        <div className={styles.bio}>
          <ul>
            ...
            <li><b className={styles.bioHeads}>Age :</b> <i>21</i> </li>
            <li><b className={styles.bioHeads}>Qualification :</b><i>B.A. LL.B , Panjab Univserity, Chandigarh (current)</i> </li>
            ...
            <li><b className={styles.bioHeads}>Experience :</b><i>Fresher</i>  </li>
          </ul>
        </div>
      </Container>
    </div>
