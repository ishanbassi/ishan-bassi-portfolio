        ...
        <Row className='mt-5'>
          <Col md="5">
            <div className={styles.skillsImg}>
              <Image  src={fullStack} alt="full stack" layout='fill'   placeholder="blur" sizes="50vw" objectFit="contain"/> 
          ...
          <Col md={{offset:2 , span:5}}>
            <div className={styles.skillsImg}>
              <Image  src={seo} alt="seo support" layout='fill'   placeholder="blur" sizes="50vw"  objectFit="contain"/>
          ...
          <Col className="mt-2" md={5}>
            <div className={styles.skillsImg}>
              <Image  src={ui} alt=" UI development" layout='fill'   placeholder="blur" sizes="50vw"  objectFit="contain" />
          ...
          <Col className="mt-2" md={{offset:2 , span:5}}>
            <div className={styles.skillsImg}>
              <Image  src={spa} alt="single page applications" layout='fill'   placeholder="blur"   objectFit="contain" sizes='50vw'/>
