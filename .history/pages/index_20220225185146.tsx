  ...
  return (
    ...
    <div className='text-center mt-5'>
      ...
      <Container>
        <Row >
          <Col md="5">
            <Image  className={styles.skillsImg}src={fullStack} alt="full stack" layout='responsive'   placeholder="blur" sizes="50vw" />
          </Col>
          <Col md={{offset:2 , span:5}}>
            <Image className={styles.skillsImg} src={seo} alt="seo support" layout='responsive'   placeholder="blur" sizes="50vw"  />
          </Col>
