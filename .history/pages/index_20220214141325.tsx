    ...
    <div className='text-center mt-5'>
      ...
      <Container className="mt-5">
        ...
        <div className={styles.bio}>
          <ul>
            <li><b className="bioHeads">Name</b> : Ishan Bassi</li>
            <li><b className="bioHeads">Age</b> : 21</li>
            <li><b className="bioHeads">Qualification</b> : B.A. LL.B , Panjab Univserity, Chandigarh (current)</li>
            <li><b className="bioHeads">Frameworks/Libraries</b> : 
              <ul>
                <li>React.Js</li>
                <li>Next.js</li>
                <li>Django</li>
            ...
            <li><b className="bioHeads">Skills</b> :
              <ul>
                <li>
            ...
            <li><b className="bioHeads">Experience</b> : Fresher</li>
          </ul>
        </div>
      </Container>
    </div>
