...
const Home: NextPage<{markdown:string}> = ({markdown}) => {
  ...
  return (
    ...
    <div className='text-center mt-5'>
      ...
      <Container fluid="md" className={styles.container}>
        <div ref={heroRef}>
          <div className={styles.profileImgCover}> 
            <Image src={ProfileImg} priority className={styles.profileImg} layout="responsive" sizes='50vw'  alt="profile-pic" ></Image>
          </div>
          <h1>Hi</h1>
      ...
      <Container fluid="md">
        <footer>
          <p>Created this site using <a href="https://nextjs.org" target="_blank" rel="noopener noreferrer">Next.js</a> </p>
        </footer>
      </Container>
