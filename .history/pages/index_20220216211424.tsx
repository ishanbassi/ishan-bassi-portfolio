          ...
          <ul>
            ...
            <li><b className={styles.bioHeads}>Frameworks/Libraries :</b> 
              <span className={styles.bioAns}>
                <ul>
                  <li id={styles.reactIcon}>
                    React.Js
            
                    </li>
                  <li id={styles.nextIcon}>Next.js</li><span>hi</span>
                  <li id={styles.djangoIcon}>Django</li>
                </ul>
              </span>
            </li>
            <li><b className={styles.bioHeads}>Skills :</b> 
              <span className={styles.bioAns}>
                  ...
                  <li>SEO optimization <i className="fa-brands fa-searchengin"></i></li>
