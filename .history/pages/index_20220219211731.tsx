    ...
    <div className='text-center mt-5'>
      ...
      <Container className="mt-5">
        <p className={styles.bioPara}>
         <em> Started Programming in 2019, I began my learning with <b>Python</b>, then moved to <b>Javascript</b>. For the past one year I am learning  and doing <b>React.js</b> projects.</em>
        </p>
      </Container>
    </div>
  )
