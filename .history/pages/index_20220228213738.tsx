  ...
  return (
    ...
    <div className='text-center mt-5'>
      ...
      <Container>
        ...
        <Row>
          <Col id={styles.fbLink} className={`${styles.socialLinks} ${styles.baseShadow} `} ><a href="https://www.facebook.com/ishan.bassi.9/" target="_blank" rel="noopener noreferrer " title="Facebook Profile"><i className={`fa-brands fa-facebook-f `}></i></a></Col>
          <Col className={`${styles.socialLinks} ${styles.baseShadow}`}><a href="https://www.instagram.com/ishan__bassi/"target="_blank" rel="noopener noreferrer "  title="Instagram Profile"><i className={`fa-brands fa-instagram-square `} id={styles.instaLink}></i></a></Col>
          <Col id={styles.linkedinLink}className={`${styles.socialLinks} ${styles.baseShadow}`}><a href="https://www.linkedin.com/in/ishan-bassi-259301206/"target="_blank" rel="noopener noreferrer "  title="LinkedIn Profile"><i className={`fa-brands fa-linkedin `}></i></a></Col>
          <Col id={styles.stackLink} className={`${styles.socialLinks} ${styles.baseShadow}`}><a href="https://stackoverflow.com/users/16685634/ishan-bassi"target="_blank" rel="noopener noreferrer "  title="Stackoverflow Profile"><i className={`fa-brands fa-stack-overflow `}></i></a></Col>
        </Row>
