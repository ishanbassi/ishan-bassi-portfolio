  ...
  return (
    ...
    <div className='text-center mt-5'>
      ...
      <Container>
        ...
        <Row>
          <Col className={styles.socialLinks}><i className={`fa-brands fa-facebook-f  ${styles.socialLinks}`}></i></Col>
          <Col><i className={`fa-brands fa-instagram-square ${styles.socialLinks}`}></i></Col>
          <Col><i className={`fa-brands fa-linkedin ${styles.socialLinks}`}></i></Col>
          <Col><i className={`fa-brands fa-stack-overflow ${styles.socialLinks}`}></i></Col>
        </Row>
