          ...
          <ul>
            <li>
              <b className={styles.bioHeads}>Name :</b>
                <i className={styles.bioAns}> Ishan Bassi</i>
               
                </li>
            <li><b className={styles.bioHeads}>Age :</b> <i className={styles.bioAns}>21</i> </li>
            <li><b className={styles.bioHeads}>Qualification :</b><i className={styles.bioAns}>B.A. LL.B , Panjab Univserity, Chandigarh (current)</i> </li>
            <li><b className={styles.bioHeads}>Frameworks/Libraries :</b> 
              <i className={styles.bioAns}>
                <ul>
                  <li>React.Js</li>
                  <li>Next.js</li>
                  <li>Django</li>
            ...
            <li><b className={styles.bioHeads}>Experience :</b><i className={styles.bioAns}>Fresher</i>  </li>
          </ul>
        </div>
      </Container>
    </div>
