        ...
        <Row >
          <Col md="5">
            <div className={styles.skillsImg}>
              <Image  src={fullStack} alt="full stack" layout='fill'   placeholder="blur" sizes="50vw" height={2000} width={3000} objectFit="contain"/> 
            </div>
          </Col>
          <Col md={{offset:2 , span:5}}>
            <Image  src={seo} alt="seo support" layout='responsive'   placeholder="blur" sizes="50vw"  />
          </Col>
          <Col md={{offset:0 , span:12}}>
            <Image  src={spa} alt=" single page applications" layout='responsive'   placeholder="blur" sizes="50vw"  />
          </Col>
