  ...
  return (
    ...
    <div className='text-center mt-5'>
      ...
      <Container>
        <Row >
          <Col md="5">
            <Image  className={styles.skillsImg}src={fullStack} alt="full stack" layout='responsive'   placeholder="blur" sizes="50vw" width={3000} height={2000} />
          </Col>
          <Col md={{offset:2 , span:5}}>
            <Image className={styles.skillsImg} src={seo} alt="seo support" layout='responsive'   placeholder="blur" sizes="50vw" width={2000} height={1840} />
          </Col>
          <Col md={{offset:3 , span:6}}>
            <Image className={styles.skillsImg} src={spa} alt=" single page applications" layout='responsive'   placeholder="blur" sizes="50vw"  />
          </Col>
