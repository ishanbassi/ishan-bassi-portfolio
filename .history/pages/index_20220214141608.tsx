    ...
    <div className='text-center mt-5'>
      ...
      <Container className="mt-5">
        ...
        <div className={styles.bio}>
          <ul>
            <li><b className={styles.bioHeads}>Name :</b>  Ishan Bassi</li>
            <li><b className={styles.bioHeads}>Age :</b>  21</li>
            <li><b className={styles.bioHeads}>Qualification :</b> B.A. LL.B , Panjab Univserity, Chandigarh (current)</li>
            ...
            <li><b className={styles.bioHeads}>Experience :</b>  Fresher</li>
          </ul>
        </div>
      </Container>
    </div>
