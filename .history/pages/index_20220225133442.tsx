      ...
      <Container>
        <Row >
          ...
          <Col md={{offset:2 , span:5}}>
            <Image  src={seo} alt="seo-support" layout='responsive'   placeholder="blur" sizes="50vw" width={2000} height={1840} />
          </Col>
          <Col md={{offset:3 , span:6}}>
            <Image  src={spa} alt="seo-support" layout='responsive'   placeholder="blur" sizes="50vw" unoptimized />
          </Col>
