        ...
        <Row >
          <Col md="5">
            <div className={styles.skillsImg}>
              <Image  src={fullStack} alt="full stack" layout='fill'   placeholder="blur" sizes="50vw" height={2000} width={3000} objectFit="cover"/> 
            </div>
          </Col>
          ...
          <Col className="mt-2" md={{offset:3 , span:6}}>
            <div className={styles.skillsImg}>
