  ...
  return (
    ...
    <div className='text-center mt-5'>
      ...
      <Container>
        ...
        <Row>
          <Col className={styles.socialLinks} ><a href="https://www.facebook.com/ishan.bassi.9/" target="_blank" rel="noopener noreferrer " title="Facebook Profile"></a><i className={`fa-brands fa-facebook-f `}></i></Col>
          <Col className={styles.socialLinks}><a href="https://www.instagram.com/ishan__bassi/"target="_blank" rel="noopener noreferrer "  title="Instagram Profile"></a><i className={`fa-brands fa-instagram-square `}></i></Col>
          <Col className={styles.socialLinks}><a href="https://www.linkedin.com/in/ishan-bassi-259301206/"target="_blank" rel="noopener noreferrer "  title="LinkedIn Profile"></a><i className={`fa-brands fa-linkedin `}></i></Col>
          <Col className={styles.socialLinks}><a href="https://stackoverflow.com/users/16685634/ishan-bassi"target="_blank" rel="noopener noreferrer "  title="Stackoverflow Profile"></a><i className={`fa-brands fa-stack-overflow `}></i></Col>
        </Row>
